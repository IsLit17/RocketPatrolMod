...
class Play extends Phaser.Scene {
    ...
    create() {
        ...
        // white borders except for bottom
        ...
        this.scoreRight = this.add.text(borderUISize + borderPadding * 39, borderUISize + borderPadding*2, 'P2: ' + this.p2Rocket.score, scoreConfig); // p2
